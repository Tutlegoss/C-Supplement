		...
		<div class="container-fluid">
			<div class="row">
				<div id="article" class="col-12">
                    ...
                    <br>
                    <button class="btn btn-info ml-3" id="codeToggle1">Code</button>
                    <br>
                    <label for="choiceNum1"># of Choices: </label>
                    <select name="choiceNum1" id="choiceNum1" class="form-control-md mt-3">
                    ...
                    <br>
                    <button class="btn btn-info ml-3" id="codeToggle2">Code</button>
                    <br>
                    <br>
                    <br>
...
<script>
	$(document).ready(function() {
        ...
        $('[id^="codeToggle"]').on('click', function() {
            selector = '#' + this.id;
            if(this.innerHTML == "Code")
            {
                this.innerHTML = "No Code";
                $(selector).removeClass('btn-info').addClass('btn-danger');
            }
            else
            {
                this.innerHTML = "Code";
                $(selector).removeClass('btn-danger').addClass('btn-info');
            }
        });
